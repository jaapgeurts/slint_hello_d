module slint.interpreter_internal;
...
public import slint.interpreter_generated_public;
import slint.vtable;
...
extern (C) {
    ...
    struct ModelAdaptorVTable {
        uintptr_t function(VRef!ModelAdaptorVTable) row_count;
        Value* function(VRef!ModelAdaptorVTable, uintptr_t row) row_data;
        void function(VRef!ModelAdaptorVTable, uintptr_t row, Box!Value value) set_row_data;
        const ModelNotifyOpaque* function(VRef!ModelAdaptorVTable) get_notify;
        void function(VRefMut!ModelAdaptorVTable) drop;
    }
    ...
    alias DynamicComponentVRc = VRc!(ItemTreeVTable, ErasedItemTreeBox);

    alias ComponentCallback = Box!Value function(void* user_data, Slice!(Box!(Value)) arg);
    ...
    alias ComponentCompilerOpaque = ComponentCompiler*;
    ...
    /// array.
    bool slint_interpreter_value_to_array(const Box!Value* val, SharedVector!(Box!(Value))* out_);
    ...
    void slint_interpreter_struct_set_field(StructOpaque* stru,
            Slice!uint8_t name, const Value* value);
    ...
    Value* slint_interpreter_component_instance_invoke(const ErasedItemTreeBox* inst,
            Slice!uint8_t name, Slice!(Box!(Value)) args);
    ...
    bool slint_interpreter_component_instance_set_callback(const ErasedItemTreeBox* inst, Slice!uint8_t name,
            ComponentCallback callback, void* user_data, void function(void*) drop_user_data);
    ...
    Value* slint_interpreter_component_instance_get_global_property(
            const ErasedItemTreeBox* inst, Slice!uint8_t global, Slice!uint8_t property_name);

    bool slint_interpreter_component_instance_set_global_property(const ErasedItemTreeBox* inst,
            Slice!uint8_t global, Slice!uint8_t property_name, const Value* val);

    /// The `callback` function must initialize the `ret` (the `ret` passed to the callback is initialized and is assumed initialized after the function)
    bool slint_interpreter_component_instance_set_global_callback(
            const ErasedItemTreeBox* inst, Slice!uint8_t global, Slice!uint8_t name,
            ComponentCallback callback, void* user_data, void function(void*) drop_user_data);
    ...
    Value* slint_interpreter_component_instance_invoke_global(const ErasedItemTreeBox* inst,
            Slice!uint8_t global, Slice!uint8_t callable_name, Slice!(Box!(Value)) args);
    ...
    void slint_interpreter_component_instance_window(const ErasedItemTreeBox* inst,
            const WindowAdapterRcOpaque** out_);
    ...
    void slint_interpreter_component_instance_create(
            const ComponentDefinitionOpaque* def, ComponentInstance* out_);
    ...
    void slint_interpreter_component_compiler_set_include_paths(
            ComponentCompilerOpaque* compiler, const SharedVector!SharedString* paths);

    void slint_interpreter_component_compiler_set_style(
            ComponentCompilerOpaque* compiler, Slice!uint8_t style);

    void slint_interpreter_component_compiler_set_translation_domain(
            ComponentCompilerOpaque* compiler, Slice!uint8_t translation_domain);

    void slint_interpreter_component_compiler_get_style(
            const ComponentCompilerOpaque* compiler, SharedString* style_out);

    void slint_interpreter_component_compiler_get_include_paths(
            const ComponentCompilerOpaque* compiler, SharedVector!SharedString* paths);

    void slint_interpreter_component_compiler_get_diagnostics(
            const ComponentCompilerOpaque* compiler, SharedVector!Diagnostic* out_diags);

    bool slint_interpreter_component_compiler_build_from_source(ComponentCompilerOpaque* compiler,
            Slice!uint8_t source_code, Slice!uint8_t path,
            ComponentDefinitionOpaque* component_definition_ptr);

    bool slint_interpreter_component_compiler_build_from_path(ComponentCompilerOpaque* compiler,
            Slice!uint8_t path, ComponentDefinitionOpaque* component_definition_ptr);

    /// Construct a new Value in the given memory location
    void slint_interpreter_component_definition_clone(
            const ComponentDefinitionOpaque* other, ComponentDefinitionOpaque* def);
    ...
    void slint_interpreter_component_definition_properties(
            const ComponentDefinitionOpaque* def, SharedVector!PropertyDescriptor* props);
    ...
    void slint_interpreter_component_definition_callbacks(
            const ComponentDefinitionOpaque* def, SharedVector!SharedString* callbacks);

    /// Returns the list of function names of the component the component definition describes
    void slint_interpreter_component_definition_functions(
            const ComponentDefinitionOpaque* def, SharedVector!SharedString* functions);

    /// Return the name of the component definition
    void slint_interpreter_component_definition_name(
            const ComponentDefinitionOpaque* def, SharedString* name);
    ...
    void slint_interpreter_component_definition_globals(
            const ComponentDefinitionOpaque* def, SharedVector!SharedString* names);
    ...
    bool slint_interpreter_component_definition_global_properties(const ComponentDefinitionOpaque* def,
            Slice!uint8_t global_name, SharedVector!PropertyDescriptor* properties);
    ...
    bool slint_interpreter_component_definition_global_callbacks(const ComponentDefinitionOpaque* def,
            Slice!uint8_t global_name, SharedVector!SharedString* names);
    ...
    const(LiveReloadingComponentInner)* slint_live_preview_new(Slice!uint8_t file_name, Slice!uint8_t component_name,
            const SharedVector!SharedString* include_paths,
            const SharedVector!SharedString* library_paths, Slice!uint8_t style);
    ...
    void slint_live_preview_set_property(const LiveReloadingComponentInner* component,
            Slice!uint8_t property, const Value* value);
    ...
    Value* slint_live_preview_invoke(const LiveReloadingComponentInner* component,
            Slice!uint8_t callback, Slice!(Box!(Value)) args);

    void slint_live_preview_set_callback(const LiveReloadingComponentInner* component, Slice!uint8_t callback,
            ComponentCallback callback_handler, void* user_data,
