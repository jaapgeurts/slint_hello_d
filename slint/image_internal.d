module slint.image_internal;

/* Generated with cbindgen:0.29.2 */

import core.stdc.stdint : uint8_t, uint32_t, int32_t, uint16_t, uintptr_t;
...
enum TexturePixelFormat : uint8_t {
...
enum BorrowedOpenGLTextureOrigin : uint8_t {
...
extern (C) {
    struct OpaqueImageVTable {
        Layout function(VRefMut!OpaqueImageVTable) drop_in_place;
        void function(const OpaqueImageVTable*, uint8_t* ptr, Layout layout) dealloc;
        /// Returns the image size
        IntSize function(VRef!OpaqueImageVTable) size;
        /// Returns a cache key
        ImageCacheKey function(VRef!OpaqueImageVTable) cache_key;
...
extern (C) {
    ...
    void slint_image_load_from_embedded_data(Slice!(uint8_t) data,
            Slice!(uint8_t) format, Image* image);
    ...
    void slint_image_set_nine_slice_edges(Image* image, uint16_t top,
