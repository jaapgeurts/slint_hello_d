module slint.builtin_structs_internal;

import std.typecons;
import core.stdc.stdint : int32_t, uint64_t;
...
extern (C) {
    ...
    struct KeyEvent {
        ...
        Tuple!(int32_t, int32_t, int32_t) replacement_range;
        ...
        Tuple!(int32_t, int32_t, int32_t) preedit_selection;
        /// The new cursor position, when None, the cursor is put after the text that was just inserted
        Tuple!(int32_t, int32_t) cursor_position;
        Tuple!(int32_t, int32_t) anchor_position;
        // /// \private
