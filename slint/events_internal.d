...
extern (C) {
    alias LogicalRect = Rect;
    alias LogicalPoint = Point2D!float;
    alias LogicalLength = float;
    ...
    struct MouseEvent {
        ...
        static MouseEvent Pressed(const LogicalPoint position,
                const PointerEventButton button, const uint8_t click_count) {
            MouseEvent result;
            // TODO: check if we must copy all fields of the object here or not.
            //         ::new (&result.pressed.position) (LogicalPoint)(position);
            result.pressed.position = position;
            result.pressed.button = button;
            result.pressed.click_count = click_count;
        ...
        static MouseEvent Released(const LogicalPoint position,
                const PointerEventButton button, const uint8_t click_count) {
            MouseEvent result;
            result.released.position = position;
            result.released.button = button;
            result.released.click_count = click_count;
        ...
        static MouseEvent Moved(const LogicalPoint position) {
            MouseEvent result;
            result.moved.position = position;
        ...
        static MouseEvent Wheel(const LogicalPoint position, const float delta_x, const float delta_y) {
            MouseEvent result;
            result.wheel.position = position;
            result.wheel.delta_x = delta_x;
            result.wheel.delta_y = delta_y;
        ...
        static MouseEvent DragMove(DropEvent _0) {
            MouseEvent result;
            result.drag_move._0 = _0;
        ...
        static MouseEvent Drop(DropEvent _0) {
            MouseEvent result;
            result.drop._0 = _0;
            result.tag = Tag.Drop;
            return result;
