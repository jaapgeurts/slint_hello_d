...
public:
    ...
    enum BorrowedOpenGLTextureOrigin : ubyte {
    ...
    void initialize() {
        ...
        writeln("Image.initialize() called");
        this.data.tag = ImageInner.Tag.ImageInner_None;
    }
...
private:
    alias Tag = ImageInner.Tag;
    ImageInner data;
}

// Image load_image_from_embedded_data(std::span<const uint8_t> data,
...
// }
//
// Image image_from_embedded_textures(const cbindgen_private::types::StaticTextures *textures)
// {
//     cbindgen_private::types::Image img(cbindgen_private::types::Image::ImageInner_None());
